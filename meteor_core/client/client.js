...
var _libMethods = require('./lib/methods');
...
(0, _libMethods.clientMethods)();
(0, _libRouter2['default'])();

},{"./lib/methods":3,"./lib/router":4}],2:[function(require,module,exports){
/* globals Mongo */
...
var SetList = new Mongo.Collection('setList');
...
var clientMethods = function clientMethods() {};

var serverMethods = function serverMethods() {
  Meteor.methods({
    createSetList: function createSetList(name) {
      if (!name) {
      ...
      _collections.SetList.insert({
        name: name,
        state: 'draft',
        createdBy: user._id,
        createdAt: (0, _moment2['default'])().format()
      });
    }
  });
};
...
},{"./collections":2,"moment":5}],4:[function(require,module,exports){
/*
  globals
...
var _viewsPagesSetListJsx = require('../views/pages/SetList.jsx');

var _viewsPagesSetListJsx2 = _interopRequireDefault(_viewsPagesSetListJsx);
...
exports['default'] = function () {
  ...
  FlowRouter.route('/setlist/:id', {
    ...
    action: function action(params) {
      ReactLayout.render(_viewsPagesSetListJsx2['default'], {
        title: 'Set List'
      });
    }
  });
...
},{"../views/pages/Home.jsx":11,"../views/pages/SetList.jsx":12}],5:[function(require,module,exports){
//! moment.js
//! version : 2.10.6
...
var AddSetList = (function (_React$Component) {
  _inherits(AddSetList, _React$Component);

  function AddSetList(props) {
    _classCallCheck(this, AddSetList);

    _get(Object.getPrototypeOf(AddSetList.prototype), 'constructor', this).call(this, props);
    this.state = {
      active: false,
      name: ''
    };
  ...
  _createClass(AddSetList, [{
    ...
    value: function submitForm(event) {
      ...
      Meteor.call('createSetList', this.state.name, function (error, result) {
        if (error) {
          console.warn(error);
          return;
        }
...
},{"./AccountsUIWrapper.jsx":6}],9:[function(require,module,exports){
/* globals React */
...
var List = (function (_React$Component) {
  ...
  _createClass(List, [{
    ...
    value: function render() {
      ...
      var header = name ? React.createElement(
        "h1",
        null,
        name
      ) : null;
      var list = this.props.items.map(function (item, index) {
        var cb = _this.props.itemCB ? _this.props.itemCB : false;
        return React.createElement(
          "div",
          {
            key: index,
            onClick: cb.bind(_this, item._id)
          },
          item.name
        );
      });
...
var _componentsAddSetListJsx = require('../components/AddSetList.jsx');

var _componentsAddSetListJsx2 = _interopRequireDefault(_componentsAddSetListJsx);
...
var Home = (function (_ReactMeteorData) {
  ...
  _createClass(Home, [{
    ...
    value: function getMeteorData() {
      var setListHandler = Meteor.subscribe('setList');

      return {
        setListLoading: !setListHandler.ready(),
        setList: _libCollections.SetList.find({
    ...
    value: function render() {
      ...
      var setList = React.createElement(
        'p',
        null,
        'Set list loading'
      );
      ...
      if (!this.data.setListLoading) {
        ...
        setList = React.createElement(_componentsListJsx2['default'], { name: 'Set lists', items: this.data.setList, itemCB: callback });
      }
      ...
      return React.createElement(
        ...
        React.createElement(_componentsAddSetListJsx2['default'], null),
        setList
      );
    }
  }]);
...
},{"../../lib/collections":2,"../components/AddSetList.jsx":7,"../components/Header.jsx":8,"../components/List.jsx":9,"../mixins/ReactMeteorData.jsx":10}],12:[function(require,module,exports){
/* globals React */
...
var SetList = (function (_React$Component) {
  ...
  function SetList(props) {
    ...
    _get(Object.getPrototypeOf(SetList.prototype), 'constructor', this).call(this, props);
    this.state = {};
  }
